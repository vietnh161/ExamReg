    ...
    <b-container class="mt-2">
      <b-row>
        ...
        <b-col lg="12" class="mt-2" md="auto">
          <img src="../assets/addMtHp.png" class="img-fluid" alt="Responsive image" />
        </b-col>
      </b-row>
    </b-container>
  </div>
...
export default {
  ...
  methods: {
    previewFiles(e) {
      var kiThiId = localStorage.kiThiId;
    ...
    commit() {
      ...
      a.isLoading = true;
      axios
        .post("http://localhost:63834/api/hocphan/addmulti", this.items)
